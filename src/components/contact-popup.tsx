...
export default function ContactPopup(props: any) {
    ...
    return <>
        <div className={"flex flex-col gap-2 text-left bg-zinc-900 fixed transition max-h-screen z-50 bottom-40 w-8/12 h-10/12 z-10 p-5 text-xs text-center drop-shadow-lg shadow-white-200 right-10 origin-right" + (open ? " opacity-100" : " -rotate-90 opacity-0 translate-x-20")}>
            ...
            <textarea className="p-1 rounded-md" placeholder="Message" />
